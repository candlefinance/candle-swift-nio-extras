...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "candle-swift-http-types", url: "https://github.com/candlefinance/swift-http-types.git", branch: "fix-candle-1.3.1"),
        .package(name: "candle-swift-http-structured-headers", url: "https://github.com/candlefinance/swift-http-structured-headers.git", branch: "fix-candle-1.4.0"),
        ...
        .package(name: "candle-swift-certificates", url: "https://github.com/candlefinance/swift-certificates.git", branch: "fix-candle-1.13.0"),
